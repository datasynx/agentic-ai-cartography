...
| --- | --- | --- |
| `diff_topology` | ✅ | Compare two discovery sessions and report added/removed/changed nodes and added/removed edges. Defaults to the two most recent sessions (base = second-most-recent, current = most-recent). |
